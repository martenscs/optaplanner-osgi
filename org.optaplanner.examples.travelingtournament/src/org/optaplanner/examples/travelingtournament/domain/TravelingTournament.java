...
public class TravelingTournament extends AbstractPersistable implements
	...
	public Collection<? extends Object> getProblemFacts() {
		...
		// Do not add the planning entity's (matchList) because that will be
		// done automatically
		return facts;
	}
	...
	public boolean equals(Object o) {
		...
		if (id == null || !(o instanceof TravelingTournament)) {
			...
			for (Iterator<Match> it = matchList.iterator(), otherIt = other.matchList
					.iterator(); it.hasNext();) {
				Match match = it.next();
