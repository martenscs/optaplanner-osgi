...
public class TravelingTournamentSolveAllTurtleTest extends
		UnsolvedDirSolveAllTurtleTest {

	public static Collection<Object[]> getSolutionFilesAsParameters() {
		return getUnsolvedDirFilesAsParameters(new TravelingTournamentDao());
	}

	public TravelingTournamentSolveAllTurtleTest(URL unsolvedDataFile) {
