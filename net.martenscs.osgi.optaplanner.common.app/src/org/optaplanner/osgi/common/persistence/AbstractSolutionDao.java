...
public abstract class AbstractSolutionDao implements SolutionDao {
	 ...
	 * portability. For example: -D{@value #DATA_DIR_SYSTEM_PROPERTY}
	 * =sources/data/
	 */
	...
	public AbstractSolutionDao(String dirName) {
		...
		// URL url = Activator.getContext().getBundle().getEntry("data/");
		// File f;
		// try {
		...
		// }
		// String dataDirPath = System.getProperty(DATA_DIR_SYSTEM_PROPERTY,
		// "data/");
