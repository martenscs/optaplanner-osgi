...
public class PatientAdmissionSchedule extends AbstractPersistable implements
		Solution<HardMediumSoftScore> {
	/**
		 * 
		 */
	...
	public Collection<? extends Object> getProblemFacts() {
		...
		// Do not add the planning entity's (bedDesignationList) because that
