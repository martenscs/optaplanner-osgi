...
public class BedDesignationSwapMove extends AbstractMove {
	...
	public boolean isMoveDoable(ScoreDirector scoreDirector) {
		return !ObjectUtils.equals(leftBedDesignation.getBed(),
				rightBedDesignation.getBed());
	}

	public Move createUndoMove(ScoreDirector scoreDirector) {
		return new BedDesignationSwapMove(rightBedDesignation,
				leftBedDesignation);
	}
	...
	public void doMove(ScoreDirector scoreDirector) {
		...
		PatientAdmissionMoveHelper.moveBed(scoreDirector, leftBedDesignation,
				oldRightBed);
		PatientAdmissionMoveHelper.moveBed(scoreDirector, rightBedDesignation,
				oldLeftBed);
	}

	public Collection<? extends Object> getPlanningEntities() {
		return Arrays.<BedDesignation> asList(leftBedDesignation,
				rightBedDesignation);
	}

	public Collection<? extends Object> getPlanningValues() {
		return Arrays.<Bed> asList(leftBedDesignation.getBed(),
				rightBedDesignation.getBed());
	}
	...
	public int hashCode() {
		return new HashCodeBuilder().append(leftBedDesignation)
				.append(rightBedDesignation).toHashCode();
	}
