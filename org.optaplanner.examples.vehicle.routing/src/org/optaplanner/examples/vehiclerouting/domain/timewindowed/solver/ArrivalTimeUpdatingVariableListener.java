...
public class ArrivalTimeUpdatingVariableListener implements
	...
	protected void updateArrivalTime(ScoreDirector scoreDirector,
		...
		Long departureTime = (previousStandstill instanceof TimeWindowedCustomer) ? ((TimeWindowedCustomer) previousStandstill)
	...
	private Long calculateArrivalTime(TimeWindowedCustomer customer,
			Long previousDepartureTime) {
		if (customer == null) {
			return null;
		}
