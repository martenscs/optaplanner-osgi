...
public class RoadSegmentLocation extends Location {
	...
	public Double getDistanceDouble(RoadSegmentLocation location) {
		Double distance = nearbyTravelDistanceMap
				.get((RoadSegmentLocation) location);
		if (distance == null) {
	...
	protected double getShortestDistanceDoubleThroughHubs(
			RoadSegmentLocation location) {
		double shortestDistance = Double.MAX_VALUE;
		for (Map.Entry<HubSegmentLocation, Double> entry : hubTravelDistanceMap
				.entrySet()) {
