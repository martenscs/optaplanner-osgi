...
public class RenewableResourceUsedDay implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1342062123880145804L;
	...
	public boolean equals(Object o) {
		if (this == o) {
			...
			return new EqualsBuilder().append(resource, other.resource)
					.append(usedDay, other.usedDay).isEquals();
		} else {
			return false;
		}
	}
	...
	public int hashCode() {
		return new HashCodeBuilder().append(resource).append(usedDay)
				.toHashCode();
	}
