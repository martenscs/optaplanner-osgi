...
public class ExecutionModeStrengthWeightFactory implements
	...
	public Comparable createSorterWeight(Schedule schedule,
		...
		for (ResourceRequirement resourceRequirement : schedule
				.getResourceRequirementList()) {
		...
		for (ResourceRequirement resourceRequirement : executionMode
			...
			if (total > resource.getCapacity()) {
				requirementDesirability += (double) (total - resource
						.getCapacity())
	...
	public static class ExecutionModeStrengthWeight implements
			Comparable<ExecutionModeStrengthWeight> {

		private final ExecutionMode executionMode;
		private final double requirementDesirability;

		public ExecutionModeStrengthWeight(ExecutionMode executionMode,
		...
		public int compareTo(ExecutionModeStrengthWeight other) {
			return new CompareToBuilder()
					// The less requirementsWeight, the less desirable resources
					// are used
					.append(requirementDesirability,
							other.requirementDesirability)
