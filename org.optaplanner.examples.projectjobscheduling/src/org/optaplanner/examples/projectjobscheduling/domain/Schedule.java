...
public class Schedule extends AbstractPersistable implements
		Solution<BendableScore> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 725773837076570269L;
	...
	@XStreamConverter(value = XStreamBendableScoreConverter.class, ints = { 1,
			2 })
