...
public class DepotAngleCustomerDifficultyWeightFactory implements
	...
	public Comparable createSorterWeight(
		...
		return new DepotAngleCustomerDifficultyWeight(customer, customer
				.getLocation().getAngle(depot.getLocation()), customer
